...
function humanStatusLabelFromStatuses(statuses: EOnboardingStatus[] | null): string | null {
  ...
  if (statuses.length === 1) {
    ...
    const map: Partial<Record<EOnboardingStatus, string>> = {
      ...
      [EOnboardingStatus.DETAILS_CONFIRMED]: "Details Confirmed",
      [EOnboardingStatus.CONTRACT_SENT]: "Contract Sent",
      [EOnboardingStatus.CONTRACT_SUBMITTED]: "Contract Submitted",
